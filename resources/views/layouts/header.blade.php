            ...
            >
              ...
              <div class="col-auto">
                <ul class="sub-navigation justify-content-end">
                  <li>
                    <a href="{{url('/signin')}}" title="Login / Register">Login</a>
                  </li>
                </ul>
              </div>
            </div>
            ...
            >
              ...
              <div class="offcanvas-body p-0 ms-lg-auto">
                <ul class="navbar-nav mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('collection')}}" title="Women">Women</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('collection')}}" title="Kids">Kids</a>
                  </li>
                  <li class="nav-item">
